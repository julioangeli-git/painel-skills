...
function srsInitUI(){
  ...
  if(!document.getElementById('srsGlobalStyles')){
    var css=document.createElement('style');css.id='srsGlobalStyles';css.textContent=
      ...
      +'[data-theme=squilui] .gaugewrap .big{font-size:24px!important;font-weight:600!important}'
      +'[data-theme=squilui] .gaugewrap .lab{font-size:8px!important;letter-spacing:.14em!important}'
      +'[data-theme=squilui] .herostats{gap:0!important;display:flex!important;align-items:stretch!important}'
      +'[data-theme=squilui] .hs{padding:4px 20px!important;text-align:center!important}'
      +'[data-theme=squilui] .hs .v{font-size:26px!important;line-height:1!important}'
      +'[data-theme=squilui] .hs .v small{font-size:14px!important;opacity:.7!important}'
